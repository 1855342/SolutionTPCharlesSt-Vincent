...
// Modifié par : Charles St-Vincent
// Date :      6 Octobre 2020
// Note : mon menu ne fonctionne pas, je ne comprend vraiment pas comment résoudre se problème, j'espère qu'à la correction je vais voir plus clair.
...
#include "Menus1855342.h"		// Bibliothèque du programmeur rassemblant les fonctions permettant la gestion des menus et la validation des choix fait dans ces menus
#include "Formes1855342.h"		// Bibliothèque du programmeur offrant des fonctions permettant de dessiner différentes formes, pleines ou vides
using namespace std;
      ...
      if (choixRemplissage != RETOUR)
	   {
		  ...
		  //On initialise la variable dans le main on lui donnant la valeur qui être générer aléatoirement entre 1 à 4
